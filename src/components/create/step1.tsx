  ...
  return (
    <div className="space-y-6 page-transition">
      ...
      <div className="animate-fade-up-delay-1">
        <label className="text-xs font-medium text-slate-500 mb-2.5 flex items-center gap-1.5">
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6 space-y-5 animate-fade-up-delay-2">
        <div>
          <div className="flex items-center justify-between mb-1.5">
            <label className="text-xs font-medium text-slate-500">课程标题 *</label>
        ...
        <div>
          <label className="text-xs font-medium text-slate-500 mb-2.5 block">选择学科</label>
        ...
        <div>
          <label className="text-xs font-medium text-slate-500 mb-2.5 block">年级</label>
