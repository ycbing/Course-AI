...
export default function SharePage() {
  ...
  return (
    <div className="min-h-screen bg-neutral-50">
      {/* Header */}
      <header className="border-b border-neutral-200 py-8">
        <div className="mx-auto max-w-4xl px-4 sm:px-6">
          <div className="flex items-center gap-3 mb-2 animate-fade-up">
            <div className="w-10 h-10 rounded-xl bg-neutral-900 flex items-center justify-center text-white font-bold text-sm shadow-lg shadow-lg">
              C
            </div>
            <div>
      ...
      <main className="mx-auto max-w-4xl px-4 sm:px-6 py-8">
        {/* Video player */}
        {course.video_url && (
          <div className="rounded-2xl border border-neutral-200 overflow-hidden mb-10 animate-fade-up-delay-2">
              ...
              <div className="px-4 py-3 flex items-center justify-between border-t border-neutral-200">
                ...
                {course.video_url && (
                  <a
                    href={course.video_url}
                    download
                    className="flex items-center gap-1.5 text-xs text-primary-400 hover:text-neutral-900 transition"
                  >
              ...
              <div className="space-y-8">
                {sections.map((s, i) => (
                  <div key={i} className="relative animate-fade-up" style={{ animationDelay: `${i * 0.08}s` }}>
                    ...
                    {/* Content card */}
                    <Card className="overflow-hidden hover:border-primary-200 transition-colors">
                      <div className="flex items-center gap-3 px-4 py-3 border-b bg-neutral-100/30 bg-white rounded-t-xl">
                      ...
                      {s.image_url && (
                        <div className="border-b bg-neutral-100/30">
                          <img
                            src={s.image_url}
                            alt={s.title}
      ...
      {/* Footer */}
      <footer className="border-t border-neutral-200 py-10 mt-12">
        <div className="mx-auto max-w-4xl px-4 sm:px-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-sm font-semibold text-neutral-600">CourseAI</span>
